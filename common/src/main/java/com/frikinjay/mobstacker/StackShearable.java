...
/**
 * A mob whose stack can be sheared as a whole: sheep, mooshrooms and snow golems, where
 * {@code stackedHarvest} pays out for every member.
 *
 * <p>Implemented by each mob's own shear mixin, because what one member's harvest is differs per
 * mob - more wool from a sheep, five mushrooms from a mooshroom, a carved pumpkin from a snow golem -
 * and both ways of shearing (a
